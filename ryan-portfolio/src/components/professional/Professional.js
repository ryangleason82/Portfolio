	...
	return (
		<div className="container mt-3">
			...
			<div className="ui">
				<div className="ui two column very relaxed grid">
					...
					<div className="column">
						<h4>Some Places I've Worked Professionally:</h4>
						<p>JP Morgan Chase & Co. (Full-time employee)</p>
						<p>Economy League</p>
						<p>JP Morgan Chase & Co. (Intern)</p>
					</div>
				</div>
			</div>
			...
			<div className="ui bulleted list">
				<div className="item">
					Optimized database queries using indexing and temp-tables to improve
					performance
				</div>
				<div className="item">
				...
				<div className="item">
					Implemented Powershell script to enforce uniformity of configuration
					files in order to reduce potential P1 issues{" "}
				</div>
				<div className="item">
			...
			<div className="ui bulleted list">
				<div className="item">
					Worked closely with non-profit client to deliver Content Management
					System website
				</div>
				<div className="item">
					Implemented design with custom code in Node JS, Apostrophe framework,
			...
			<div className="ui bulleted list">
				...
				<div className="item">
					Hosted on internal cloud headlessly to leverage cloud environment
				</div>
				<div className="item">
					Developed using Python with cloud compliant database integration
				</div>
				<div className="item">
					Exposed to source control, agile and scrum practices, open source
					libraries, and security practices
				</div>
			</div>
		</div>
	);
